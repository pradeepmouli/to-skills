...
```ts
constructor(options: SimpleMeshOptions): MeshSimple
```

**Properties:**

- `autoUpdate: boolean` — Controls whether the mesh's vertex buffer is automatically updated each frame.
...
const triangleMesh = new MeshSimple({
  ...
  uvs: new Float32Array([
    0,
    0, // Map top-left of texture
    1,
    0, // Map top-right of texture
    0.5,
    1 // Map bottom-center of texture
  ])
});
