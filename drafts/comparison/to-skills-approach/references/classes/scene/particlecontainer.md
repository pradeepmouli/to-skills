...
_extends `ViewContainer<ParticleBuffer>`_
...
- `addChild<U>(_children: U): U[0]` — This method is not available in ParticleContainer.

Calling this method will throw an error. Please use `ParticleContainer.addParticle()` instead.

- `removeChild<U>(_children: U): U[0]` — This method is not available in ParticleContainer.
  Calling this method will throw an error. Please use `ParticleContainer.removeParticle()` instead.
- `removeChildren(_beginIndex?: number, _endIndex?: number): ContainerChild[]` — This method is not available in ParticleContainer.

Calling this method will throw an error. Please use `ParticleContainer.removeParticles()` instead.

- `removeChildAt<U>(_index: number): U` — This method is not available in ParticleContainer.

Calling this method will throw an error. Please use `ParticleContainer.removeParticleAt()` instead.

- `getChildAt<U>(_index: number): U` — This method is not available in ParticleContainer.

Calling this method will throw an error. Please use `ParticleContainer.getParticleAt()` instead.

- `setChildIndex(_child: ContainerChild, _index: number): void` — This method is not available in ParticleContainer.

Calling this method will throw an error. Please use `ParticleContainer.setParticleIndex()` instead.

- `getChildIndex(_child: ContainerChild): number` — This method is not available in ParticleContainer.

Calling this method will throw an error. Please use `ParticleContainer.getParticleIndex()` instead.

- `addChildAt<U>(_child: U, _index: number): U` — This method is not available in ParticleContainer.

Calling this method will throw an error. Please use `ParticleContainer.addParticleAt()` instead.

- `swapChildren<U>(_child: U, _child2: U): void` — This method is not available in ParticleContainer.

Calling this method will throw an error. Please use `ParticleContainer.swapParticles()` instead.

- `reparentChild(_child: ContainerChild[]): any` — This method is not available in ParticleContainer.

Calling this method will throw an error.

- `reparentChildAt(_child: ContainerChild, _index: number): any` — This method is not available in ParticleContainer.
