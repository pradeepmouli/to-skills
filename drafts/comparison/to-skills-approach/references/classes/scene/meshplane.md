...
```ts
constructor(options: MeshPlaneOptions): MeshPlane
```

**Properties:**

- `autoResize: boolean` — Controls whether the mesh geometry automatically updates when the texture dimensions change.
