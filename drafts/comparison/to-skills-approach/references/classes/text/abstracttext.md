...
_extends `ViewContainer<GPU_DATA>`_
_implements `View`_

```ts
constructor<TEXT_STYLE, TEXT_STYLE_OPTIONS, TEXT_OPTIONS, GPU_DATA>(options: TEXT_OPTIONS, styleClass: (options: TEXT_STYLE_OPTIONS) => TEXT_STYLE): AbstractText<TEXT_STYLE, TEXT_STYLE_OPTIONS, TEXT_OPTIONS, GPU_DATA>
```
