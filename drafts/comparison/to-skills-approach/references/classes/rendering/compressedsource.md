...
_extends `TextureSource<Uint8Array[]>`_

```ts
constructor(options: TextureSourceOptions): CompressedSource
```
...
- `resource: Uint8Array<ArrayBufferLike>[]` — the resource that will be uploaded to the GPU. This is where we get our pixels from
