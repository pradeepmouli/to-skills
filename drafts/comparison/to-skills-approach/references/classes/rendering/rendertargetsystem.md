...
```ts
constructor<RENDER_TARGET>(renderer: Renderer): RenderTargetSystem<RENDER_TARGET>
```
...
- `adaptor: RenderTargetAdaptor<RENDER_TARGET>` — a reference to the adaptor that interfaces with WebGL / WebGP
  **Methods:**
