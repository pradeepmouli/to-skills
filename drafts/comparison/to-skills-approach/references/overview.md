...
```ts
import { isWebGLSupported, isWebGPUSupported, isSafari, isMobile } from 'pixi.js';
...
- See isWebGLSupported for WebGL detection
- See isWebGPUSupported for WebGPU detection
- See isMobile for mobile device detection
- See path for path utilities
